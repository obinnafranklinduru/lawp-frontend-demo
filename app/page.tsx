    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] gap-12 text-center">
      <div className="max-w-2xl space-y-6">
        ...
        <p className="text-lg md:text-xl text-[var(--color-brand-text-muted)] leading-relaxed">
          The Libertas Alpha Water Project. A decentralized, zero-custody
          protocol for fractional campaign funding, transparent revenue routing,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
        <Link
          href="/app"
          className="glass-panel p-8 flex flex-col items-center gap-4 hover:-translate-y-2 transition-transform"
        >
          ...
          <h2 className="text-2xl font-bold">Contributor Portal</h2>
          <p className="text-[var(--color-brand-text-muted)] text-sm">
            Discover pools, track your Impact Tokens, and claim your continuous
            yield.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-[var(--color-brand-text-muted)] text-sm">
            Review, sign, and relay EIP-712 payloads to route real-world
            revenue.
          </p>
        </Link>
        ...
        >
          <div className="w-16 h-16 rounded-full bg-[var(--color-brand-warning)]/20 flex items-center justify-center">
            <svg
              className="w-8 h-8 text-[var(--color-brand-warning)]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <p className="text-[var(--color-brand-text-muted)] text-sm">
            Deploy contribution pools, settle capital, and manage emergency
            states.
          </p>
        </Link>
      </div>
